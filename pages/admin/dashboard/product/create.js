...
import AdminInput from "../../../../components/input/inputs/adminInputs";
...
export default function create({ parents, categories }) {
  ...
  const validate = Yup.object({
    name: Yup.string()
      ...
      .min(10, "Product name must between 10 adn 300 characters")
      .max(300, "Product name must between 10 adn 300 characters"),
    brand: Yup.string().required("Please Add a brand"),
    category: Yup.string().required("Please Add a category"),
    // subCategories: Yup.array()
    //   .required("Please Add a subCategories")
    //   .min(1, "Please Add a subCategories"),
    sku: Yup.string().required("Please Add a sku"),
    // discount: Yup.number().required("Please Add a discount"),
    color: Yup.string().required("Please Add a color"),
    // images: Yup.string().required("Please Add a images"),
    // description_images: Yup.string().required("Please Add a description"),
    description: Yup.string()
      .required("Please Add a description")
      .min(10, "Product description must between 10 adn 300 characters"),
  });
  ...
  const createProductHandler = async () => {
    ...
    if (product.color.image) {
      ...
      let cloudinary_style_img = await upload(formData);
